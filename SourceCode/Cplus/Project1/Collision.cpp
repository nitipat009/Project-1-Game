...
namespace Collision
{
	...
	bool PixelPerfectTest(const sf::RectangleShape& Object1, const sf::RectangleShape& Object2, sf::Uint8 AlphaLimit) {
		...
		if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection)) {
			...
			O1SubRect.width = abs(O1SubRect.width);
			O2SubRect.width = abs(O2SubRect.width);
	...
	bool PixelPerfectTest(const sf::CircleShape& Object1, const sf::RectangleShape& Object2, sf::Uint8 AlphaLimit) {
		sf::FloatRect Intersection;
		if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection)) {

			sf::IntRect O1SubRect = Object1.getTextureRect();
			sf::IntRect O2SubRect = Object2.getTextureRect();
			O1SubRect.width = abs(O2SubRect.width);
			O2SubRect.width = abs(O2SubRect.width);
			sf::Uint8* mask1 = Bitmasks.GetMask(Object1.getTexture());
			sf::Uint8* mask2 = Bitmasks.GetMask(Object2.getTexture());
